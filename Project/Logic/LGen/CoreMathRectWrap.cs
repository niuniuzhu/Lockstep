...
namespace XLua.CSObjectWrap
{
    ...
    public class CoreMathRectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Core.Math.Rect);
        ...
        static int __EqMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<Core.Math.Rect>(L, 1) && translator.Assignable<Core.Math.Rect>(L, 2))
				{
					Core.Math.Rect leftside;translator.Get(L, 1, out leftside);
					Core.Math.Rect rightside;translator.Get(L, 2, out rightside);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to right hand of == operator, need Core.Math.Rect!");
        ...
        static int _m_Set(RealStatePtr L)
        {
		    try {
                ...
                Core.Math.Rect __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.Set( x, y, width, height );
                        ...
                        translator.UpdateCoreMathRect(L, 1, __cl_gen_to_be_invoked);
        ...
        static int _m_Contains(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 3&& translator.Assignable<Core.Math.Vec3>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    Core.Math.Vec3 point;translator.Get(L, 2, out point);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.Math.Rect.Contains!");
        ...
        static int _m_Overlaps(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<Core.Math.Rect>(L, 2)) 
                {
                    Core.Math.Rect other;translator.Get(L, 2, out other);
                ...
                if(__gen_param_count == 3&& translator.Assignable<Core.Math.Rect>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    Core.Math.Rect other;translator.Get(L, 2, out other);
                    bool allowInverse = LuaAPI.lua_toboolean(L, 3);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.Math.Rect.Overlaps!");
        ...
        static int _m_NormalizedToPoint_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Core.Math.Vec2 normalizedRectCoordinates;translator.Get(L, 2, out normalizedRectCoordinates);
                    
                        Core.Math.Vec2 __cl_gen_ret = Core.Math.Rect.NormalizedToPoint( rectangle, normalizedRectCoordinates );
        ...
        static int _m_ToString(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Core.Math.Rect.ToString!");
        ...
        static int _g_get_zero(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.PushCoreMathRect(L, Core.Math.Rect.zero);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_position(RealStatePtr L)
        {
		    try {
                ...
                Core.Math.Rect __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushCoreMathVec2(L, __cl_gen_to_be_invoked.position);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_center(RealStatePtr L)
        {
		    try {
                ...
                Core.Math.Rect __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushCoreMathVec2(L, __cl_gen_to_be_invoked.center);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_min(RealStatePtr L)
        {
		    try {
                ...
                Core.Math.Rect __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushCoreMathVec2(L, __cl_gen_to_be_invoked.min);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_max(RealStatePtr L)
        {
		    try {
                ...
                Core.Math.Rect __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushCoreMathVec2(L, __cl_gen_to_be_invoked.max);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_size(RealStatePtr L)
        {
		    try {
                ...
                Core.Math.Rect __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushCoreMathVec2(L, __cl_gen_to_be_invoked.size);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_position(RealStatePtr L)
        {
		    try {
                ...
                Core.Math.Rect __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                Core.Math.Vec2 __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
