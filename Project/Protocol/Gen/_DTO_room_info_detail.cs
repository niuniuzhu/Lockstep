...
{
	public class _DTO_room_info_detail : DTO
	{
		public string host;
public string map;
public string name;
...
public int roomId;
		...
		public _DTO_room_info_detail(  )
		{
			
		}
public _DTO_room_info_detail( string host,string map,string name,_DTO_player_info[] players,int roomId )
		{
			this.host = host;
this.map = map;
this.name = name;
